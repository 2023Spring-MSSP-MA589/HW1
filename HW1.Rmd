...
Moreover, $\sigma_1 \geq \sigma_2 \geq \sigma_3 \geq ... \geq \sigma_n \geq 0$.\
...
2)  If $A+E$ is singular, since we know $||E||_2 < 1/||A^{-1}||_2$, and $\sigma_1 \geq \sigma_2 \geq \sigma_3 \geq ... \geq \sigma_n \geq 0$.\
We can get that $||A^{-1}||_2=\sigma_m$, and $||E||_2 < \sigma_m^{-1}$.
Then by the previous question, we can get that $\sigma_m \leq \min\limits_{A_0\in R^{m\times m}, A_0 singular}||A-A_0||_2 \leq ||A-(A+E)||_2=||-E||_2=||E||_2 < 1/||A^{-1}||_2=\sigma_m^{-1}$. Because of the contradiction, $A+E$ is non-singular.
